...
class Transaction:
    ...
    def commit(self) -> None:
        ...
        logger.debug(
            "Committing transaction %s (%d operations)", self.transaction_id, len(self.operations)
        )
    ...
    def rollback(self) -> None:
        ...
        logger.warning(
            "Rolling back transaction %s (%d operations)", self.transaction_id, len(self.operations)
        )
        ...
        logger.info(
            "Transaction %s rolled back - log preserved at %s", self.transaction_id, self.log_path
        )
